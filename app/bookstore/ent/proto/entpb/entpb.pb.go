...
type BsUser_Status int32

const (
	BsUser_STATUS_UNSPECIFIED BsUser_Status = 0
	BsUser_PENDING            BsUser_Status = 1
	BsUser_ACTIVE             BsUser_Status = 2
)

// Enum value maps for BsUser_Status.
var (
	BsUser_Status_name = map[int32]string{
		0: "STATUS_UNSPECIFIED",
		1: "PENDING",
		2: "ACTIVE",
	}
	BsUser_Status_value = map[string]int32{
...
func (x BsUser_Status) Enum() *BsUser_Status {
	p := new(BsUser_Status)
	*p = x
	return p
}

func (x BsUser_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BsUser_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_entpb_entpb_proto_enumTypes[0].Descriptor()
}

func (BsUser_Status) Type() protoreflect.EnumType {
	return &file_entpb_entpb_proto_enumTypes[0]
}

func (x BsUser_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BsUser_Status.Descriptor instead.
func (BsUser_Status) EnumDescriptor() ([]byte, []int) {
...
type BsUser struct {
	...
	Status   BsUser_Status `protobuf:"varint,4,opt,name=status,proto3,enum=entpb.BsUser_Status" json:"status,omitempty"`
}
...
func (x *BsUser) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BsUser) ProtoMessage() {}

func (x *BsUser) ProtoReflect() protoreflect.Message {
	mi := &file_entpb_entpb_proto_msgTypes[0]
...
// Deprecated: Use BsUser.ProtoReflect.Descriptor instead.
func (*BsUser) Descriptor() ([]byte, []int) {
	return file_entpb_entpb_proto_rawDescGZIP(), []int{0}
}

func (x *BsUser) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *BsUser) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *BsUser) GetPoints() uint64 {
	if x != nil {
		return x.Points
	}
	return 0
...
func (x *BsUser) GetStatus() BsUser_Status {
	if x != nil {
		return x.Status
	}
	return BsUser_STATUS_UNSPECIFIED
}
...
var file_entpb_entpb_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x22, 0xb5, 0x01, 0x0a, 0x06, 0x42,
	0x73, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x04, 0x52, 0x06, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x12, 0x2c, 0x0a, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x65, 0x6e, 0x74, 0x70,
	0x62, 0x2e, 0x42, 0x73, 0x55, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	0x10, 0x02, 0x42, 0x2b, 0x5a, 0x29, 0x73, 0x6c, 0x61, 0x73, 0x68, 0x2d, 0x61, 0x64, 0x6d, 0x69,
	0x6e, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2f,
...
var file_entpb_entpb_proto_goTypes = []interface{}{
	(BsUser_Status)(0), // 0: entpb.BsUser.Status
	(*BsUser)(nil),     // 1: entpb.BsUser
}
var file_entpb_entpb_proto_depIdxs = []int32{
	0, // 0: entpb.BsUser.status:type_name -> entpb.BsUser.Status
