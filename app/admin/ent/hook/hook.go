...
func (f SysDictionaryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.SysDictionaryMutation)
	if !ok {
...
func (f SysDictionaryDetailFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.SysDictionaryDetailMutation)
	if !ok {
...
// Mutate calls f(ctx, m).
func (f SysOauthProviderFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.SysOauthProviderMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SysOauthProviderMutation", m)
	}
	return f(ctx, mv)
}
...
// The SysTokenFunc type is an adapter to allow the use of ordinary
// function as SysToken mutator.
type SysTokenFunc func(context.Context, *ent.SysTokenMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SysTokenFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.SysTokenMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SysTokenMutation", m)
	}
	return f(ctx, mv)
}
